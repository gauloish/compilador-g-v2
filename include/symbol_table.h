...
SymbolEntry* symbol_entry_create(const char*, SymbolDataType, SymbolKind, SymbolParameters*, int, int);
...
SymbolKind symbol_entry_get_kind(SymbolEntry*);
SymbolParameters* symbol_entry_get_parameters(SymbolEntry*);
int symbol_entry_get_position(SymbolEntry*);
int symbol_entry_get_amount(SymbolEntry*);

SymbolTable* symbol_table_create(void);
void symbol_table_delete(SymbolTable*);
void symbol_table_add_symbol(SymbolTable*, SymbolEntry*);
...
void symbol_scope_add_symbol(SymbolScope*, SymbolEntry*);
